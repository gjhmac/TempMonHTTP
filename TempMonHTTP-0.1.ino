    ...
    while (client.connected()) {
      if (client.available()) {
        ...
        if (c == '\n' && currentLineIsBlank) {
          ...
          client.println("<br /><p>Served to you by a Freetronics EtherTen Arduino connected to a Freetronics DHT22 Temperature/Humidity Sensor</p>");
          client.println("</body>");
          client.println("</html>");
          break;
        }
